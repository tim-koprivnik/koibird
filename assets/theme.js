...
var headerBOTTOM = document.querySelector(".site-nav");

// Get the offset position of the header/navbar
var sticky = headerBOTTOM.offsetTop;

// Add the sticky class to the header/navbar when you reach its scroll position. Remove "sticky" when you leave the scroll position
function myFunction() {
  if (window.pageYOffset >= sticky) {
    header.classList.add("sticky");
    // headerBOTTOM.classList.add("sticky");
    document.querySelector("#search__line--id").classList.remove("search__line");
    document.querySelector("#search-icon").style.display = "none";
    document.querySelector("#login-and-register--id").style.display = "none";
    document.querySelector(".site-nav").style.marginTop = "0px";
    document.querySelector(".site-nav").style.marginBottom = "0px";
    document.querySelector(".site-header__logo").style.width = "30%";
    document.querySelector(".site-header.logo--center").style.paddingTop = "0px";
    document.querySelector(".fa-heart").style.marginTop = "33px";
    document.querySelector(".site-header__cart").style.marginTop = "30px";
  } else {
    header.classList.remove("sticky");
    // headerBOTTOM.classList.remove("sticky");
    document.querySelector("#search__line--id").classList.add("search__line");
    document.querySelector("#search-icon").style.display = "block";
    document.querySelector("#login-and-register--id").style.display = "block";
    document.querySelector(".site-nav").style.marginTop = "25px";
    document.querySelector(".site-nav").style.marginBottom = "25px";
    document.querySelector(".site-header__logo").style.width = "100%";
    document.querySelector(".site-header.logo--center").style.paddingTop = "30px";
    document.querySelector(".fa-heart").style.marginTop = "0px";
    document.querySelector(".site-header__cart").style.marginTop = "0px";
  }
}


// document.querySelector(".section-header").style.width = "1920px";
// document.querySelector(".section-header").style.paddingLeft = "0px";
// document.querySelector(".section-header").style.paddingRight = "0px";
